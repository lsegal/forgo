...
// Code generated by 'forgo test cmd/go -v -run=^TestDocsUpToDate$ -fixdocs'; DO NOT EDIT.
// Edit the documentation in other files and then execute 'forgo generate cmd/go' to generate this one.

// Forgo is a tool for managing Go source code.
//
// Usage:
//
//	forgo <command> [arguments]
//
// The commands are:
//
...
//	fmt         forgofmt (reformat) package sources
...
//	test        test packages
//	tool        run specified forgo tool
//	upgrade     upgrade forgo by re-running the platform install script
//	update      alias for 'forgo upgrade'
//	version     print Go version
//	vet         report likely mistakes in packages
//
// Use "forgo help <command>" for more information about a command.
//
...
//
// Use "forgo help <topic>" for more information about that topic.
//
// # Start a bug report
//
// Usage:
...
// Usage:
//
//	forgo build [-o output] [build flags] [packages]
//
...
// Usage:
//
//	forgo clean [-i] [-r] [-cache] [-testcache] [-modcache] [-fuzzcache] [build flags] [packages]
//
...
// Usage:
//
//	forgo doc [doc flags] [package|[package.]symbol[.methodOrField]]
//
...
// Usage:
//
//	forgo env [-json] [-changed] [-u] [-w] [var ...]
//
...
// Usage:
//
//	forgo fix [build flags] [-fixtool prog] [fix flags] [packages]
//
...
//
// # Forgofmt (reformat) package sources
//
// Usage:
//
//	forgo fmt [-n] [-x] [packages]
//
...
// Usage:
//
//	forgo generate [-run regexp] [-n] [-v] [-x] [build flags] [file.go... | packages]
//
...
// Usage:
//
//	forgo get [-t] [-u] [-tool] [build flags] [packages]
//
...
// Usage:
//
//	forgo install [build flags] [packages]
//
...
// Usage:
//
//	forgo list [-f format] [-json] [-m] [list flags] [build flags] [packages]
//
...
//
// Use "forgo help mod <command>" for more information about a command.
//
// # Download modules to local cache
//
// Usage:
//
//	forgo mod download [-x] [-json] [-reuse=old.json] [modules]
//
...
// Usage:
//
//	forgo mod edit [editing flags] [-fmt|-print|-json] [go.mod]
//
...
// Usage:
//
//	forgo mod tidy [-e] [-v] [-x] [-diff] [-go=version] [-compat=version]
//
...
// Usage:
//
//	forgo mod why [-m] [-vendor] packages...
//
...
//	vendor      make vendored copy of dependencies
//
// Use "forgo help work <command>" for more information about a command.
//
// # Edit go.work from tools or scripts
//
// Usage:
//
//	forgo work edit [editing flags] [go.work]
//
...
// Usage:
//
//	forgo work vendor [-e] [-v] [-o outdir]
//
...
// Usage:
//
//	forgo run [build flags] [-exec xprog] package [arguments...]
//
...
// Usage:
//
//	forgo test [build/test flags] [packages] [build/test flags & test binary flags]
//
...
//
// # Run specified forgo tool
//
// Usage:
//
//	forgo tool [-n] command [args...]
//
...
//
// # Upgrade forgo by re-running the platform install script
//
// Usage:
//
//	forgo upgrade [version]
//
// Upgrade fetches and runs forgo's platform install script -- the same
...
//
// Alias for 'forgo upgrade'
//
// Usage:
//
//	forgo update [version]
//
// Update is an alias for 'forgo upgrade'; see 'forgo help upgrade'.
//
// # Print Go version
//
// Usage:
//
//	forgo version [-m] [-v] [-json] [file ...]
//
...
// Usage:
//
//	forgo vet [build flags] [-vettool prog] [vet flags] [packages]
//
