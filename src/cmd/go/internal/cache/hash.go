...
// versions of the forgo command (or even different Git commits during
...
//
// We strip any GOEXPERIMENTs the forgo tool was built with from this
// version string on the assumption that they shouldn't affect forgo tool
